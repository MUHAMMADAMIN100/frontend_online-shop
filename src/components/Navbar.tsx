...
export default function Navbar() {
  ...
  return (
    <header className="animate-navSlideDown" style={{ position: "sticky", top: 0, zIndex: 100 }}>
      ...
      {/* Верхняя строка */}
      <div style={{ backgroundColor: "#8B0000", padding: "6px 0", textAlign: "center", transition: "padding 0.3s" }}>
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
            ...
            {/* Корзина */}
            <Link to="/cart" style={{ position: "relative", textDecoration: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, transition: "transform 0.2s" }}
            ...
            {/* История заказов */}
            {token && (
              <Link to="/orderHistory" style={{ textDecoration: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 4, transition: "transform 0.2s" }}
                onMouseEnter={e => (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)"}
                onMouseLeave={e => (e.currentTarget as HTMLElement).style.transform = "translateY(0)"}
              >
                <svg width="22" height="22" fill="none" stroke="#1A1A1A" strokeWidth="1.5" viewBox="0 0 24 24">
            ...
            {token ? (
              <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                ...
                <button
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = "#8B0000"; (e.currentTarget as HTMLElement).style.color = "#FFFFFF"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = "transparent"; (e.currentTarget as HTMLElement).style.color = "#8B0000"; }}
                >
                  Выйти
                </button>
              </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <Link to="/register" style={{
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = "#8B0000"; (e.currentTarget as HTMLElement).style.transform = "translateY(-1px)"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = "#FF0000"; (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; }}
                >
                  Регистрация
                </Link>
              </div>
